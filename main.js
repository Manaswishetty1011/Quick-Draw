...
document.getElementById("sketch-given").innerHTML="Sketch To Be Drawn:" + Element_of_array;
...
function updateCanvas(){
    ...
    Element_of_array = Quick_draw_data_set[Random_no];
    sketch = Element_of_array;
    document.getElementById("sketch-given").innerHTML = "Sketch To Be Drawn: "+sketch;
}
...
function gotResults(error,results){
    ...
    document.getElementById("percentage").innerHTML = "Percentage: "+Math.round(results[0].confidence * 100)+"%";
}